...
public class Test_UnderArmourEx {
    ...
    */
    ...
    public void Test_02_Instagram() throws InterruptedException, IOException {
        ...
        for (int i = 0; i < images.size(); i++) {
            ...
            if (count > 0) {
                ...
                File file1 = new File("C:\\demo\\UnderArmourEx.xls");
    ...
    @Test(enabled = false)
    public void Test_03_Instagram() throws InterruptedException, IOException {
